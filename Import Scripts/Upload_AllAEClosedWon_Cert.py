...
ProcessName = 'Update AE closed won opportunities'
fileName = 'All AE Closed Won.csv'
filePath =  r'G:\Shared drives\Confidential.Finance\Finance.Squad\Confidential Finance\FP&A\PowerBi\1. Datasets and Uploads\Anaplan SFDC Uploads'
...
#upload data
anaplan.loadFile(fullFilePath,'113000000114')
